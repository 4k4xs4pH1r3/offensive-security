...
ports_to_open = [
    ...
    {'Port': 1900, 'Protocol': 'udp', 'Purpose': 'SSDP (Simple Service Discovery Protocol)'},
    ...
    {'Port': 5355, 'Protocol': 'udp', 'Purpose': 'LLMNR (Link-Local Multicast Name Resolution)'},
    ...
    {'Port': [8554, 8558], 'Protocol': 'tcp', 'Purpose': 'RTSP (Real Time Streaming Protocol)'},
    {'Port': [8554, 8558], 'Protocol': 'udp', 'Purpose': 'RTSP (Real Time Streaming Protocol)'},
    {'Port': [5000, 5020], 'Protocol': 'tcp', 'Purpose': 'UPnP or other applications'},
    {'Port': 7680, 'Protocol': 'tcp', 'Purpose': 'Delivery Optimization (Windows Update P2P)'},
    {'Port': 10246, 'Protocol': 'tcp', 'Purpose': 'Registered port (application specific)'},
    {'Port': 10247, 'Protocol': 'tcp', 'Purpose': 'Registered port (application specific)'},
    {'Port': 17472, 'Protocol': 'tcp', 'Purpose': 'Registered port (application specific)'},
